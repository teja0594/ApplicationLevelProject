...
d:Date=new Date()
  invest(itype:any):any{
   var transactions:any={date:this.d
    ,out : 0
    ,int : 0
    ,balance:0
    ,type:""
    ...
    if(itype=="stocks")
    {
      ...
      transactions.in="-----"
      transactions.balance=this.money-=transactions.out
      ...
      this.money=(Number)(this.money)+(Number) (transactions.in)
     transactions.balance=this.money
